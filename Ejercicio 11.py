...
#hasta finales de año, se te añaden al balance final de tu cuenta de
#ahorros. Escribir un programa que comience leyendo la cantidad de dinero
#depositada en la cuenta de ahorros, introducida por el usuario. Después
#el programa debe calcular ymostrar por pantalla la cantidad de ahorros tras
